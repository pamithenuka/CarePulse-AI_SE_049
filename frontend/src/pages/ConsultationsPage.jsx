...
export default function ConsultationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    setMessage(null)
    try {
      await api.createConsultationSummary({
        slotId: form.slotId,
    ...
    <div>
      ...
      <div className="card">
        ...
        <p className="card-desc">
          Find the Slot ID on the Appointment slots page (or from a patient's booking confirmation) once
          Student 1's patient module is wired in.
        </p>
